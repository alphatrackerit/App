...
public sealed class Payment : AggregateRoot<Guid>
{
    ...
    /// forecast payment exists before its invoice is received. Only ever a <c>Recibida</c> invoice.</summary>
    ...
    /// <summary>Links this payment to (or, with <c>null</c>, unlinks it from) a fiscal invoice.
