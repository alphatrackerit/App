...
namespace FSH.Modules.Cashflow.Features.v1.Suppliers;

public sealed class CreateSupplierCommandHandler(CashflowDbContext db) : ICommandHandler<CreateSupplierCommand, Guid>
{
...
public sealed class UpdateSupplierCommandHandler(CashflowDbContext db) : ICommandHandler<UpdateSupplierCommand, Guid>
{
...
public sealed class DeleteSupplierCommandHandler(CashflowDbContext db) : ICommandHandler<DeleteSupplierCommand, Unit>
{
