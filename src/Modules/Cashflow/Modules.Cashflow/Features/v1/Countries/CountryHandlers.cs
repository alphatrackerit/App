...
namespace FSH.Modules.Cashflow.Features.v1.Countries;

public sealed class CreateCountryCommandHandler(CashflowDbContext db) : ICommandHandler<CreateCountryCommand, Guid>
{
...
public sealed class UpdateCountryCommandHandler(CashflowDbContext db) : ICommandHandler<UpdateCountryCommand, Guid>
{
...
public sealed class DeleteCountryCommandHandler(CashflowDbContext db) : ICommandHandler<DeleteCountryCommand, Unit>
{
