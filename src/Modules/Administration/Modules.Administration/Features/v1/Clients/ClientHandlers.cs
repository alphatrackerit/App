...
using FSH.Modules.Administration.Contracts.v1.Clients;
using FSH.Modules.Administration.Data;
using FSH.Modules.Administration.Domain;
using Mediator;
using Microsoft.EntityFrameworkCore;

namespace FSH.Modules.Administration.Features.v1.Clients;

public sealed class CreateClientCommandHandler(AdministrationDbContext db) : ICommandHandler<CreateClientCommand, Guid>
{
...
public sealed class UpdateClientCommandHandler(AdministrationDbContext db) : ICommandHandler<UpdateClientCommand, Guid>
{
...
public sealed class DeleteClientCommandHandler(AdministrationDbContext db) : ICommandHandler<DeleteClientCommand, Unit>
{
...
public sealed class SearchClientsQueryHandler(AdministrationDbContext db) : IQueryHandler<SearchClientsQuery, PagedResponse<LookupDto>>
{
