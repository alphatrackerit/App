...
public sealed class CreateCompanyCommandHandler(AdministrationDbContext db) : ICommandHandler<CreateCompanyCommand, Guid>
{
...
public sealed class UpdateCompanyCommandHandler(AdministrationDbContext db) : ICommandHandler<UpdateCompanyCommand, Guid>
{
...
public sealed class DeleteCompanyCommandHandler(AdministrationDbContext db) : ICommandHandler<DeleteCompanyCommand, Unit>
{
...
public sealed class SearchCompaniesQueryHandler(AdministrationDbContext db) : IQueryHandler<SearchCompaniesQuery, PagedResponse<LookupDto>>
{
