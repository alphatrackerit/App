...
builder.Services.AddMediator(o =>
{
    ...
    o.Assemblies = [
        ...
        typeof(FSH.Modules.Projects.Contracts.ProjectsContractsMarker),
        typeof(FSH.Modules.Projects.ProjectsModule),
        typeof(FSH.Modules.Administration.Contracts.AdministrationContractsMarker),
        typeof(FSH.Modules.Administration.AdministrationModule),
        typeof(FSH.Modules.Avicola.Contracts.AvicolaContractsMarker),
        typeof(FSH.Modules.Avicola.AvicolaModule),
...
var moduleAssemblies = new Assembly[]
{
    ...
    typeof(FSH.Modules.Projects.ProjectsModule).Assembly,
    typeof(FSH.Modules.Administration.AdministrationModule).Assembly,
    typeof(FSH.Modules.Avicola.AvicolaModule).Assembly,
