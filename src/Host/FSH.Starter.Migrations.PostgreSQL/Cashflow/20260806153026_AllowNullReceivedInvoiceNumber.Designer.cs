...
namespace FSH.Starter.Migrations.PostgreSQL.Cashflow
{
    ...
    [Migration("20260806153026_AllowNullReceivedInvoiceNumber")]
    partial class AllowNullReceivedInvoiceNumber
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FSH.Modules.Cashflow.Domain.Invoice", b =>
                {
                    ...
                    b.ToTable("Facturas", "cashflow", t =>
                        {
                            t.HasCheckConstraint("CK_Facturas_Numero_Emitida", "(\"Tipo\" = 'Recibida') OR (\"Numero\" IS NOT NULL)");
